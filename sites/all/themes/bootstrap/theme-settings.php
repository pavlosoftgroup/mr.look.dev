...
function bootstrap_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['general']['images']['bootstrap_image_shape'] = array(
    ...
    '#description' => t('Add classes to an <code>&lt;images&gt;</code> element to easily style images in any project. Note: Internet Explorer 8 lacks support for rounded corners. See: <a href="!bootstrap_url" target="_blank">Image Shapes</a>', array(
      '!bootstrap_url' => 'http://getbootstrap.com/css/#images-shapes',
    )),
    '#default_value' => bootstrap_setting('image_shape', $theme),
    '#empty_option' => t('None'),
    '#options' => array(
      'images-rounded' => t('Rounded'),
      'images-circle' => t('Circle'),
      'images-thumbnail' => t('Thumbnail'),
    ),
  );
  $form['general']['images']['bootstrap_image_responsive'] = array(
    ...
    '#description' => t('Images in Bootstrap 3 can be made responsive-friendly via the addition of the <code>.images-responsive</code> class. This applies <code>max-width: 100%;</code> and <code>height: auto;</code> to the image so that it scales nicely to the parent element.'),
  );
